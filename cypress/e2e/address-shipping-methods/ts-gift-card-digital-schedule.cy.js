describe("Ts Gift Card schedule digital Shipping Method", ()=>{
    //Note: select/add in cart.json as simple product "monetary-digital-033003" this product to verify the schedule payment method
